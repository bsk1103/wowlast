...
large_buttons = {
    "나의 아바타": "아바타비디오.mp4",  # 이 경로를 실제 아바타 비디오 파일로 변경하세요.
    "나를 표현한 음악": "잔잔노래.mp3"  # 이 경로를 실제 음악 파일로 변경하세요.
}

small_buttons = {
    "나의 장점": "맡은 바를 묵묵히 함.",
    "희망 진로": "자동차 엔지니어가 되고 싶습니다.",
    "좋아하는 것": "게임하기, 친구들과 노는 것을 좋아합니다.",
    "싫어하는 것": "적정 선을 지킨다면 딱히 없음.",
    "자기 소개": "이름은 봉성권이고 19살이야.",
    "진로 준비": "뉴스나 인터넷에서 궁금했던 점을 찾아보고 해결하려고 함.",
    "취미 활동": "게임을 함.",
    "성공 사례": "친구들과 멘토링을 하여 수학 성적을 올려본 경험이 있음."
}
...
if st.session_state.active_button == "나의 아바타":
    st.video("아바타비디오.mp4", format="video/mp4", start_time=0)

if st.session_state.active_button == "나를 표현한 음악":
    st.audio("잔잔노래.mp3", format="audio/mp3")
